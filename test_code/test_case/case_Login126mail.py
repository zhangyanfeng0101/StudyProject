...
from test_code.public import location
from test_code.public import saveScreenshot
from test_code.public import plogin126mail
...
class Login126Mail(unittest.TestCase):
	...
	def action(self, case_id, case_summary, username, password):
		...
		print ("========【" + case_id + u"】" + case_summary + u"=============")
		print (username)
		print (password)
